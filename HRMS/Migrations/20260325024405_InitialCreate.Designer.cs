...
namespace HRMS.Migrations
{
    ...
    [Migration("20260325024405_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSCertificate", b =>
                {
                    ...
                    b.HasIndex("EnrollmentId")
                        .HasDatabaseName("IX_LMSCertificates_EnrollmentId");

                    b.HasIndex("TenantId");

                    b.HasIndex("CertificateNumber", "TenantId")
                        .IsUnique()
                        .HasDatabaseName("IX_LMSCertificates_Number_Tenant");

                    b.ToTable("LMSCertificates", (string)null);
                });
            ...
            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSCourse", b =>
                {
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_LMSCourses_IsActive");

                    b.HasIndex("SkillId");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("IX_LMSCourses_TenantId");

                    b.ToTable("LMSCourses", (string)null);
                });

            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSEmployeeSkill", b =>
                {
                    b.Property<int>("EmployeeSkillId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("EmployeeSkillId"));
                    ...
                    b.ToTable("LMSEmployeeSkills");
                });

            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSEnrollment", b =>
                {
                    b.Property<int>("EnrollmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CourseId")
                        .HasDatabaseName("IX_LMSEnrollments_CourseId");

                    b.HasIndex("StaffId")
                        .HasDatabaseName("IX_LMSEnrollments_StaffId");

                    b.HasIndex("TenantId");

                    b.ToTable("LMSEnrollments", (string)null);
                });
            ...
            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSProgress", b =>
                {
                    ...
                    b.ToTable("LMSProgress");
                });

            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSQuiz", b =>
                {
                    b.Property<int>("QuizId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LMSQuizzes");
                });

            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSQuizAttempt", b =>
                {
                    ...
                    b.ToTable("LMSQuizAttempts");
                });

            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSQuizQuestion", b =>
                {
                    ...
                    b.ToTable("LMSQuizQuestions");
                });

            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSRecommendation", b =>
                {
                    ...
                    b.ToTable("LMSRecommendations");
                });

            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSSkill", b =>
                {
                    b.Property<int>("SkillId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSCertificate", b =>
                {
                    b.HasOne("HRMS.Core.Domain.Entities.LMSEnrollment", "Enrollment")
                        .WithMany()
                        .HasForeignKey("EnrollmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HRMS.Core.Domain.Entities.Tenant", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSCourse", b =>
                {
                    ...
                    b.HasOne("HRMS.Core.Domain.Entities.LMSSkill", "Skill")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSEnrollment", b =>
                {
                    b.HasOne("HRMS.Core.Domain.Entities.LMSCertificate", "Certificate")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.Core.Domain.Entities.LMSModule", b =>
                {
                    ...
                    b.HasOne("HRMS.Core.Domain.Entities.LMSQuiz", "Quiz")
                        .WithMany()
